"""
Backfill Opening Odds for 2025 NFL Season
...
def update_opening_line(conn, game_id, opening_spread, opening_total, timestamp):
    ...
    if row is None:
        ...
        movement = latest_line - opening_spread
        cursor.execute('''
...
def main():
    print("=" * 80)
    print("BACKFILLING 2025 NFL OPENING ODDS")
    print("=" * 80)

    conn = sqlite3.connect('nfl_games.db')
    matcher = GameMatcher('nfl_games.db')

    # 2025 NFL weeks and their approximate opening dates
    week_opening_dates = [
        (1, '2025-08-31T12:00:00Z'),   # Week 1 - lines out early
        (2, '2025-09-08T12:00:00Z'),
        (3, '2025-09-15T12:00:00Z'),
        (4, '2025-09-22T12:00:00Z'),
        (5, '2025-09-29T12:00:00Z'),
        (6, '2025-10-06T12:00:00Z'),
        (7, '2025-10-13T12:00:00Z'),
        (8, '2025-10-20T12:00:00Z'),
        (9, '2025-10-27T12:00:00Z'),
        (10, '2025-11-03T12:00:00Z'),
        (11, '2025-11-10T12:00:00Z'),
        (12, '2025-11-17T12:00:00Z'),
        (13, '2025-11-24T12:00:00Z'),
    ]
