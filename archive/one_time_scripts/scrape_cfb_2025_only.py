"""
Scrape ONLY 2025 CFB season with drive data
Ensures 2025 data is preserved
"""
...
def main():
    print("=" * 80)
    print("SCRAPING 2025 CFB SEASON WITH DRIVE DATA")
    print("=" * 80)
    ...
    # Scrape 2025 season (weeks 1-15)
    print(f"\nScraping 2025 CFB season (weeks 1-15)...")
