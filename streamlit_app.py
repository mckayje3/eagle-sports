...
def show_nba_predictions_live():
    ...
    # NBA season = ending year of season (2026 = Oct 2025 - June 2026)
    season = 2026
...
def show_cbb_predictions_live():
    ...
    # CBB season = ending year of academic season (2026 = Nov 2025 - Mar 2026)
    season = 2026
...
def show_nhl_predictions_live():
    """Show live NHL predictions for 2025-26 season"""
    st.markdown("### 🏒 NHL 2025-26 Predictions")

    # NHL season = year it ends (2026 = Oct 2025 - Jun 2026)
    season = 2026
