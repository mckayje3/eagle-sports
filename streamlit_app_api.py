"""
Sports Prediction App - API-Dependent Version (DEPRECATED)
This version requires a separate FastAPI server running on localhost:8000.
For the main app, use streamlit_app.py instead (self-contained, no API needed).
"""
