"""
NFL Deep Eagle Edge Analysis: Neural Network vs Vegas
...
SPREAD CONVENTION: point_spread = away_score - home_score
...
FEATURE_FILES = [
    'nfl_2022_2024_deep_eagle_features.csv',
    'nfl_2024_2025_deep_eagle_features.csv',
]
...
def run_edge_analysis():
    ...
    print("=" * 70)
    print("NFL DEEP EAGLE EDGE ANALYSIS (MLP Neural Network)")
    print("=" * 70)
    ...
    # Note: point_spread in feature file uses home - away, so we negate it or recalculate
    ...
    exclude_cols = [
        ...
        'actual_spread',
        # Exclude Vegas odds from features (we compare against them, not use them)
    ...
    results = []
    min_train_games = 150  # Need enough data to train neural network
    ...
    for i in range(min_train_games, len(df)):
        ...
        # Train MLP (retrain every 50 games for efficiency)
